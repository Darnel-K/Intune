<#
    .SYNOPSIS
        Automatically installs the Quick Assist app
    ...
    .DESCRIPTION
        This script provides a way to automatically install the Quick Assist app.
        The inspiration for this script came after watching the Greg Shields' Pluralsight course on Intune where
        it appears that the only current mechanism to autodeploy the Quick Assist is through Microsoft Store for
